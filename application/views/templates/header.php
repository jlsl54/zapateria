					...
					<div class="col-sm-6">
						<div class="contactinfo">
							<ul class="nav nav-pills">
								<li><a href="#"><i class="fa fa-phone"></i> +34 669603961</a></li>
								<li><a href="#"><i class="fa fa-envelope"></i> marieta.sagunto@gmail.com</a></li>
							</ul>
						</div>
					</div>
					<div class="col-sm-6">
		...
		<div class="header-middle"><!--header-middle-->
			<div class="container">
				<div class="row">
					...
					<ul class="nav navbar-nav">';
                            if($this->session->userdata("logeado") == TRUE):
                                echo '<li><a href="' . base_url() . 'cuenta"><i class="fa fa-user"></i> Mi cuenta</a></li>';
                            endif;
                            echo '
				...
				<li><a href="' . base_url() . 'carrito"><i class="fa fa-shopping-cart"></i> Carrito</a></li>';
                            ...
                            if($this->session->userdata("logeado") == TRUE):
                                echo '<li><a href="' . base_url() . 'logout"><i class="fa fa-sign-out"></i> Cerrar sesión</a></li>';
                            endif;
                            echo '
							</ul>
						</div>
