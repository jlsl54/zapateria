	...
	<section id="do_action">
		<div class="container">
			<div class="heading">
				...
				<p>Una vez finalizada la compra, este será enviado a su domicilio, y lo tendrá tambien disponible en versión digital.</p>
			</div>
			<div class="row">
				<div class="col-sm-12">
					<div class="total_area">
						<ul>
							...
							<li><Iva <span> 0.00 €</span></li>
							<li>Coste de envio <span>xxxxxxx</span></li>
